...
public class Blog_page {
	...
	BlogsPage page = PageFactory.initElements(TestBase.driver, BlogsPage.class);
	private static final Logger LOG = Logger.getLogger(Blog_page.class);
	...
	public void click_on_manufacture_link_falcon() {
		TestBase.driver.executeScript("window.scrollBy(0,3500)");
		wait.implicitWait(5);
	...
	public void write_comment() {
		...
		TestBase.driver.executeScript("window.scrollBy(0,5000)");
		wait.implicitWait(5);
